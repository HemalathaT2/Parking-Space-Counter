...
def checkParkingSpace(imgPro):
    ...
    for pos in posList:
        ...
        if count < 900:
            ...
            thickness = 10
            available+=1
            cv2.rectangle(img,pos,(pos[0]+width, pos[1] + height),color,thickness=5)
        ...
        cvzone.putTextRect(img,f'Available: {available}/{len(posList)}',(100,50),scale = 3,thickness= 5,offset=20,colorR=(0,180,0))
